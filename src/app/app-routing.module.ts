...
const routes: Routes = [
  ...
  },
  {
    ...
    // NCP Admin
      ...
      { path: 'c-dashboard', loadChildren: () => import('./partial/client/c-dashboard/c-dashboard.module').then(m => m.CDashboardModule) , data: { title: 'Dashboard', allowedRoles: ['8'] }},
      { path: 'assign-agents-to-booths', loadChildren: () => import('./partial/client/assign-agents-to-booths/assign-agents-to-booths.module').then(m => m.AssignAgentsToBoothsModule), data: { title: 'Dashboard', allowedRoles: ['8'] } },
