...
const routes: Routes = [
  ...
  },
  {
    ...
    component: PartialComponent, children: [
      ...
      { path: 'masters/party-program-master', loadChildren: () => import('./partial/masters/party-program-master/party-program-master.module').then(m => m.PartyProgramMasterModule) },
