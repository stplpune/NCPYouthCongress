...
const routes: Routes = [
  ...
  },
  {
    ...
    component: PartialComponent, children: [
      ...
      { path: 'committee', loadChildren: () => import('./partial/masters/organization-master-new/organization-master.module').then(m => m.OrganizationMasterModule), data: { title: 'Committee Master', allowedRoles: ['1', '2', '5','9'] } },
