...
export class RecentPostDetailsComponent implements OnInit {
  ...
  dashboardActivities(flag: any) {
    this.spinner.show();
    this.callAPIService.setHttp('get', 'Dashboard_Activities_Web?UserId=' + this.commonService.loggedInUserId() + '&PageNo=' + this.pageNo, false, false, false, 'ncpServiceForWeb');
  ...
  getLikesList(activityId: any) {
    ...
    this.spinner.show();
    this.callAPIService.setHttp('get', 'GetLikesList_1_0?ActivityId=' + activityId, false, false, false, 'ncpServiceForWeb');
    this.callAPIService.getHttp().subscribe((res: any) => {
      if (res.data == 0) {
  ...
  insertLikesList(activityId: any) {
    this.spinner.show();
    this.callAPIService.setHttp('get', 'InsertLikes_1_0?ActivityId=' + activityId + '&LikeTypeId=1&UserId=' + this.commonService.loggedInUserId(), false, false, false, 'ncpServiceForWeb');
    this.callAPIService.getHttp().subscribe((res: any) => {
      if (res.data == 0) {
  ...
  getCommentsList(activityId: any) {
    this.spinner.show();
    this.callAPIService.setHttp('get', 'GetCommentsList_1_0?ActivityId=' + activityId, false, false, false, 'ncpServiceForWeb');
    this.callAPIService.getHttp().subscribe((res: any) => {
      if (res.data == 0) {
  ...
  deleteComments(id: any) {
    ...
    this.callAPIService.setHttp('get', 'DeleteComments_1_0?' + obj, false, false, false, 'ncpServiceForWeb');
    this.callAPIService.getHttp().subscribe((res: any) => {
      if (res.data == 0) {
